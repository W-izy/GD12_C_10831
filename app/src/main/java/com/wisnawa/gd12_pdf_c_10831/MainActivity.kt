package com.wisnawa.gd12_pdf_c_10831
...
import com.wisnawa.gd12_pdf_c_10831.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String){
        ...
        val file = File(pdfPath, "pdf_10831.pdf")
        ...
        @SuppressLint("useCompatLoadingForDrawables") val d = getDrawable(R.drawable.ww)
